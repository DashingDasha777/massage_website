...
- Fonts come from a single Google Fonts `<link>` (Yeseva One, Caveat, Comfortaa — all Cyrillic-complete) with `preconnect` hints, present in both pages' `<head>`. Any new font must include the Cyrillic subset.
